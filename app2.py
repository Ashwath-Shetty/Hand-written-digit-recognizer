...
ar="Currently 94 characters are recognizable including - Alphabets(A-Z or a-z), Numbers(0-9), Any Symbols and Special Characters(for e.x: @, ], # etc.).<b> <br>Note: Use Computer for the better experience.</b>"
